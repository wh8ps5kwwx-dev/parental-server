...
/** جدولة WorkManager — مزامنة + حظر + تقارير (دوري + حلقة كل دقيقتين). */
object MonitoringScheduler {
    ...
    fun schedule(context: Context) {
        val periodic = PeriodicWorkRequestBuilder<MonitoringWorker>(15, TimeUnit.MINUTES)
            .build()
    ...
    /** حلقة خلفية متكررة — تعيد جدولة نفسها بعد كل تنفيذ. */
